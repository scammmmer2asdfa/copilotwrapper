...
This is the exact, unmodified license text distributed with the official
@github/copilot npm package (fetched and verified against published version
1.0.82). It applies to the `copilot`/`copilot.exe` binaries vendored in the
sibling platform directories under resources/copilot-cli/ — not to any other
part of this repository, which is covered by the LICENSE file at the repo
root instead.
